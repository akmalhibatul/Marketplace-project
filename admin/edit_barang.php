                        ...
                        <div class="card-body">
                            ...
                            ?>
                                <form action="update_barang.php" method="POST" enctype="multipart/form-data">
                                    <input type="text" name="id_barang" value="<?= $br['id_barang']; ?>" hidden>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control" name="unit">
                                            ...
                                            <option <?= ($un == 'Meter') ? "selected" : "" ?> value="Meter">Meter</option>
                                            <option <?= ($un == 'Inc') ? "selected" : "" ?> value="Inc">Inc</option>
                                            <option <?= ($un == 'Qty') ? "selected" : "" ?> value="Qty">Qty</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>Foto barang</label><br>
                                        <img src="img/barang/<?php echo $br['foto_barang']; ?>" style="width: 120px;float: left;margin-bottom: 10px;">
