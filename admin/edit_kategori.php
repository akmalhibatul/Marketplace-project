            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="kategori.php" class="d-sm-inline-block btn btn-sm btn-danger shadow-sm">Kembali</a>
                    </div>
                            ...
                            ?>
                                <form action="update_kategori.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="img/kategori/<?php echo $row['foto_kategori']; ?>" style="width: 120px;float: left;margin-bottom: 10px;">
                                        <input type="file" class="form-control-file" name="foto_kategori">
                                    </div>
