  ...
  <main id="main">
    ...
    <div class="wrapper">
      <div class="list-group">
        ...
        <a href="edit.php" class="list-group-item list-group-item-action active">Edit Profil</a>
      ...
      <div class="core">
        ...
        ?>
          <form action="edit_proses.php" method="post">
            <input type="text" name="id_user" value="<?= $pr['id_user']; ?>" hidden>
            <div class="form-group mt-3 mb-3">
              <label for="name">Nama Lengkap</label>
              <input type="text" class="form-control" name="nama" value="<?= $pr['nama']; ?>" required>
            </div>

            <div class="form-group mt-3 mb-3">
              <label for="name">Telepon</label>
              <input type="number" min="0" class="form-control" name="telp" value="<?= $pr['telp']; ?>" required>
            </div>
          <?php } ?>
