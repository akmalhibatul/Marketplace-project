  ...
  <main id="main">
    ...
    <div class="wrapper">
      ...
      <div class="core">
        ...
        ?>
          <?php if ($dt['status'] == 1) { ?>
            <a href="bayar.php?id_bukti=<?= $dt['id_bukti']; ?>" class="btn btn-md btn-danger">Bayar</a>
          <?php } elseif ($dt['status'] == 2) { ?>
            <div class="alert alert-warning fst-italic fw-bold" role="alert">
              Mohon Tunggu , Sedang Proses Verifikasi Oleh Admin
            </div>
          <?php } elseif ($dt['status'] == 3) { ?>
            <div class="alert alert-warning fst-italic fw-bold" role="alert">
              Mohon Tunggu , Sedang di proses oleh admin
            </div>
          ...
          <table class="table table-sm table-borderless">
            <tbody>
              ...
              <tr>
                ...
                <?php } elseif ($dt['status'] == '4') { ?>
                  <td class="text-info">Dikirim</td>
                <?php } elseif ($dt['status'] == '5') { ?>
          ...
          <?php if ($dt['status'] == 6) { ?>
            <div class="alert alert-danger" role="alert">
              Alasan : <b><?= $dt['keterangan']; ?></b>
            </div>
          <?php } ?>
          <?php if ($dt['status'] == '4') { ?>
            <a href="terima.php?id_tr=<?= $dt['id_transaksi']; ?>" onclick="return confirm('Apakah barang Anda Sudah Sampai ?')" class="btn btn-md btn-success">Diterima</a>
            <small class="text-danger text-sm">*Klik Diterima Bila Barang Sudah Sampai</small>
          <?php } ?>
          <hr>
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="progress">
                <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" <?php if ($dt['status'] == '2') {
            ...
            <div class="col-md-3">
              ...
              <div class="progress">
                <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" <?php if ($dt['status'] == '3') {
                                                                                                                                                                            echo "style='width: 100%'";
                                                                                                                                                                          } ?>></div>
              </div>
            </div>
            <div class="col-md-3">
              ...
              <div class="progress">
                <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" <?php if ($dt['status'] == '4') {
                                                                                                                                                                            echo "style='width: 100%'";
                                                                                                                                                                          } ?>></div>
              </div>
            </div>
            <div class="col-md-3">
              ...
              <div class="progress">
                <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" <?php if ($dt['status'] == '5') {
                                                                                                                                                                            echo "style='width: 100%'";
                                                                                                                                                                          } ?>></div>
              </div>
            </div>
